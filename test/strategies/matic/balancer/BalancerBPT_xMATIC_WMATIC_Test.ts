...
describe.skip('BalancerBPT_xMATIC_WMATIC_Test', async () => {
  ...
  const underlying = BaseAddresses.BALANCER_xMATIC_MATIC;
  const poolId = BaseAddresses.BALANCER_xMATIC_MATIC_ID;
  const gauge = BaseAddresses.BALANCER_xMATIC_MATIC_GAUGE;
  const depositToken = BaseAddresses.WMATIC_TOKEN;
