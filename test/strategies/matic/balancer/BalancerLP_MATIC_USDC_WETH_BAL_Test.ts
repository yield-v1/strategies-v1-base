...
describe.skip('BalancerLP_MATIC_USDC_WETH_BAL_Test', async () => {
  ...
  const underlying = BaseAddresses.BALANCER_POOL_MATIC_USDC_WETH_BAL;
  const poolId = BaseAddresses.BALANCER_POOL_MATIC_USDC_WETH_BAL_ID;
  const gauge = BaseAddresses.BALANCER_GAUGE_MATIC_USDC_WETH_BAL;
  const depositToken = BaseAddresses.BAL_TOKEN;
