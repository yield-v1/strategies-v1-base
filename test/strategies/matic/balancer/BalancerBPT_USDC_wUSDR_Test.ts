...
describe.skip('BalancerBPT_USDC_wUSDR_Test', async () => {
  ...
  const underlying = BaseAddresses.BALANCER_USDC_wUSDR;
  const poolId = BaseAddresses.BALANCER_USDC_wUSDR_ID;
  const gauge = BaseAddresses.BALANCER_USDC_wUSDR_GAUGE;
  const depositToken = BaseAddresses.USDC_TOKEN;
