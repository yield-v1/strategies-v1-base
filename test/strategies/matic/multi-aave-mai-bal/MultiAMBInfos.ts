...
const infos: IAMBInfo[] = [
  {
    underlyingName: 'AAVE',
    underlying: BaseAddresses.AAVE_TOKEN,
    camToken: BaseAddresses.camAAVE_TOKEN,
    amToken: BaseAddresses.amAAVE_TOKEN,
    stablecoin: BaseAddresses.camAAVEVault,
    targetPercentage: '300',
  },
  {
    underlyingName: 'WMATIC',
    underlying: BaseAddresses.WMATIC_TOKEN,
    camToken: BaseAddresses.camWMATIC_TOKEN,
    amToken: BaseAddresses.amWMATIC_TOKEN,
    stablecoin: BaseAddresses.camWMATICVault,
    targetPercentage: '300',
  },
  // ------ We do not have DAI vaults
  // {
  //   underlyingName: 'DAI',
  //   underlying: BaseAddresses.DAI_TOKEN,
  //   camToken: BaseAddresses.camDAI_TOKEN,
  //   amToken: BaseAddresses.amDAI_TOKEN,
  //   stablecoin: BaseAddresses.camDAIVault,
  //   targetPercentage: '250',
  // },
  {
    underlyingName: 'WBTC',
    underlying: BaseAddresses.WBTC_TOKEN,
    camToken: BaseAddresses.camWBTC_TOKEN,
    amToken: BaseAddresses.amWBTC_TOKEN,
    stablecoin: BaseAddresses.camWBTCVault,
    targetPercentage: '300',
    collateralNumerator: '10000000000' // 10**10 for WBTC erc20Stablecoin-cam-wbtc.sol at mai-qidao
  },
  {
    underlyingName: 'WETH',
    underlying: BaseAddresses.WETH_TOKEN,
    camToken: BaseAddresses.camWETH_TOKEN,
    amToken: BaseAddresses.amETH_TOKEN,
    stablecoin: BaseAddresses.camWETHVault,
    targetPercentage: '300',
  },
]
