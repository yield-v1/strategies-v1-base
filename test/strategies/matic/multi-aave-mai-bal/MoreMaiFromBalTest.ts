...
import {IStrategy, ISmartVault, StrategyAaveMaiBal} from "../../../../typechain";
...
export class MoreMaiFromBalTest extends SpecificStrategyTest {
  ...
  public async do(
    ...
    it("More Mai from Balancer", async () => {
      ...
      const token = BaseAddresses.miMATIC_TOKEN;
      await TokenUtils.getToken(BaseAddresses.WMATIC_TOKEN, signer.address, addAmount);
